...
/***/ function(module, exports, __webpack_require__) {
	...
	var insertBefore = function insertBefore(element, reevooComponent) {
	...
	var closeInsertModal = function closeInsertModal(event) {
	  if (event) {
	    event.stopPropagation();
	  }
	...
	var openInsertModal = function openInsertModal(element) {
	  ...
	  var $buttonAfter = (0, _jquery2.default)('<button type="button">After</button>');
	  $buttonAfter.on('click', insertAfter(element, reevooComponent));
	  var $buttonCancel = (0, _jquery2.default)('<button type="button">Cancel</button>');
	  $buttonCancel.on('click', closeInsertModal);
	
	  var $buttonBar = (0, _jquery2.default)('<div class="reevoo-mockator-insert_modal__buttons_bar"></div>');
	  $buttonBar.append($buttonBefore);
	  $buttonBar.append($buttonAfter);
	  $buttonBar.append($buttonCancel);
	
	  var $title = (0, _jquery2.default)('<h5>Select where you want to insert the element:</h5>');
	
	  var $modal = (0, _jquery2.default)('<div class="reevoo-mockator-insert_modal"></div>');
	  var $content = (0, _jquery2.default)('<div class="reevoo-mockator-insert_modal__content"></div>');
...
/***/ }
/******/ ]);
//# sourceMappingURL=mockator.js.map